...
func NewParser(reader io.Reader) *Parser {
	l := lexer.NewLexer(reader,
		...
		[]lexer.TokenType{
			...
			lexer.NewSimpleTokenType(LCB, "{", false, 1),
			lexer.NewSimpleTokenType(RCB, "}", false, 1),
			...
			lexer.NewSimpleTokenType(EQ, "=", false, 1),
			lexer.NewSimpleTokenType(GT, ">", false, 1),
			lexer.NewSimpleTokenType(GTE, ">=", false, 1),
			lexer.NewSimpleTokenType(LT, "<", false, 1),
			lexer.NewSimpleTokenType(LTE, "<=", false, 1),
			lexer.NewSimpleTokenType(NE, "!=", false, 1),
			lexer.NewSimpleTokenType(NE, "<>", false, 1),
			lexer.NewSimpleTokenType(NSEQ, "<=>", false, 1),
			lexer.NewSimpleTokenType(QSTN, "?", false, 1),
			lexer.NewSimpleTokenType(TILDE, "~", false, 1),

			lexer.NewSimpleTokenType(AND, "AND", true, 1),
			lexer.NewSimpleTokenType(AND, "&&", false, 1),
			lexer.NewSimpleTokenType(OR, "||", true, 1),
			lexer.NewSimpleTokenType(XOR, "XOR", true, 1),
			lexer.NewSimpleTokenType(IS, "IS", true, 1),
			lexer.NewSimpleTokenType(PIPE, "|", false, 1),
			lexer.NewSimpleTokenType(BIT_AND, "&", false, 1),
			lexer.NewSimpleTokenType(RSHIFT, "<<", false, 1),
			lexer.NewSimpleTokenType(LSHIFT, ">>", false, 1),
			lexer.NewSimpleTokenType(PLUS, "+", false, 1),
			lexer.NewSimpleTokenType(MINUS, "-", false, 1),
			lexer.NewSimpleTokenType(MULT, "*", false, 1),
			lexer.NewSimpleTokenType(DIV, "/", false, 1),
			lexer.NewSimpleTokenType(DIV, "DIV", true, 1),
			lexer.NewSimpleTokenType(MOD, "%", false, 1),
			lexer.NewSimpleTokenType(MOD, "MOD", true, 1),
			lexer.NewSimpleTokenType(HAT, "^", false, 1),
			lexer.NewSimpleTokenType(NOT, "NOT", true, 1),
			lexer.NewSimpleTokenType(EXCL, "!", false, 1),
			lexer.NewSimpleTokenType(SOUNDS, "SOUNDS", true, 1),
			lexer.NewSimpleTokenType(LIKE, "LIKE", true, 1),
			lexer.NewSimpleTokenType(BETWEEN, "BETWEEN", true, 1),
			lexer.NewSimpleTokenType(ROW, "ROW", true, 1),
			lexer.NewSimpleTokenType(UNKNOWN, "UNKNOWN", true, 1),
			lexer.NewSimpleTokenType(REGEXP, "REGEXP", true, 1),
			// Statement
			...
			lexer.NewRegexpTokenType(EXISTS, "EXISTS", true, 1),
			...
			lexer.NewSimpleTokenType(NATURAL, "NATURAL", true, 1),
			lexer.NewSimpleTokenType(LANGUAGE, "LANGUAGE", true, 1),
			lexer.NewSimpleTokenType(MODE, "MODE", true, 1),
			lexer.NewSimpleTokenType(QUERY, "QUERY", true, 1),
			lexer.NewSimpleTokenType(EXPANSION, "EXPANSION", true, 1),
			lexer.NewSimpleTokenType(AGAINST, "AGAINST", true, 1),
			lexer.NewSimpleTokenType(CASE, "CASE", true, 1),
			lexer.NewSimpleTokenType(WHEN, "WHEN", true, 1),
			lexer.NewSimpleTokenType(THEN, "THEN", true, 1),
			lexer.NewSimpleTokenType(END, "END", true, 1),
			lexer.NewSimpleTokenType(ELSE, "ELSE", true, 1),
			lexer.NewSimpleTokenType(CASE, "CASE", true, 1),
			lexer.NewSimpleTokenType(IF, "IF", true, 1),

			lexer.NewSimpleTokenType(INTERVAL, "INTERVAL", true, 1),
			lexer.NewSimpleTokenType(MICROSECOND, "MICROSECOND", true, 1),
			lexer.NewSimpleTokenType(SECOND, "SECOND", true, 1),
			lexer.NewSimpleTokenType(MINUTE, "MINUTE", true, 1),
			lexer.NewSimpleTokenType(HOUR, "HOUR", true, 1),
			lexer.NewSimpleTokenType(DAY, "DAY", true, 1),
			lexer.NewSimpleTokenType(WEEK, "WEEK", true, 1),
			lexer.NewSimpleTokenType(MONTH, "MONTH", true, 1),
			lexer.NewSimpleTokenType(QUARTER, "QUARTER", true, 1),
			lexer.NewSimpleTokenType(SECOND_MICROSECOND, "SECOND_MICROSECOND", true, 1),
			lexer.NewSimpleTokenType(MINUTE_MICROSECOND, "MINUTE_MICROSECOND", true, 1),
			lexer.NewSimpleTokenType(MINUTE_SECOND, "MINUTE_SECOND", true, 1),
			lexer.NewSimpleTokenType(HOUR_MICROSECOND, "HOUR_MICROSECOND", true, 1),
			lexer.NewSimpleTokenType(HOUR_SECOND, "HOUR_SECOND", true, 1),
			lexer.NewSimpleTokenType(HOUR_MINUTE, "HOUR_MINUTE", true, 1),
			lexer.NewSimpleTokenType(DAY_MICROSECOND, "DAY_MICROSECOND", true, 1),
			lexer.NewSimpleTokenType(DAY_SECOND, "DAY_SECOND", true, 1),
			lexer.NewSimpleTokenType(DAY_MINUTE, "DAY_MINUTE", true, 1),
			lexer.NewSimpleTokenType(DAY_HOUR, "DAY_HOUR", true, 1),
			lexer.NewSimpleTokenType(YEAR_MONTH, "YEAR_MONTH", true, 1),

			lexer.NewSimpleTokenType(CURRENT_USER, "CURRENT_USER", true, 1),
			lexer.NewSimpleTokenType(CURRENT_DATE, "CURRENT_DATE", true, 1),
			lexer.NewSimpleTokenType(CURRENT_ROLE, "CURRENT_ROLE", true, 1),
			lexer.NewSimpleTokenType(UTC_DATE, "UTC_DATE", true, 1),
			lexer.NewSimpleTokenType(CURRENT_TIME, "CURRENT_TIME", true, 1),
			lexer.NewSimpleTokenType(LOCALTIME, "LOCALTIME", true, 1),
			lexer.NewSimpleTokenType(LOCALTIMESTAMP, "LOCALTIMESTAMP", true, 1),
			lexer.NewSimpleTokenType(UTC_TIME, "UTC_TIME", true, 1),
			lexer.NewSimpleTokenType(UTC_TIMESTAMP, "UTC_TIMESTAMP", true, 1),
